...
public class LoginServiceImpl implements LoginService {
    ...
    public void increaseAttemptsCounter(final String login) {
        AccountEntity accountEntity = accountRepository.findByLogin(login).orElseThrow(() -> new NoSuchElementException(ACCOUNT_ALREADY_EXIST_BY_LOGIN));
    ...
    public void resetAttemptsCounter(final String login) {
        AccountEntity accountEntity = accountRepository.findByLogin(login).orElseThrow(
                () -> new NoSuchElementException(ACCOUNT_ALREADY_EXIST_BY_LOGIN));
